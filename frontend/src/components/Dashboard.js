      ...
      <form method="GET">
        <div className="card shadow text-center" >
          ...
          <div className="card-body">
            ...
            <hr />
            <div className="row my-4 linkDisplay">
            ...
            {userData.blogs && userData.blogs.map((blog) => (
              <div className="row container-fluid my-3">
                <div className="bold-title col-md-4 fs-5">
                  {blog.title}
                </div>
                <div className="col-md-4 fs-5">
                  {blog.topic}
                ...
                <div className='menuDisplay'><hr /></div>
              </div>
              
            ))}
          </div>
          <hr className='linkDisplay'/>
          <div className="row text-center my-3">
            <div className="col-4 col-md-3 mx-auto my-4">
